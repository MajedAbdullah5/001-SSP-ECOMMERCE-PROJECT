...
<div class='drop'><img src=' $image 'height='100px'width='100px'></div><div><p id='ball'class='column'>$name </p></div><div><p class='column'>$ $price</p></div><div id='cart'><a href='overlay3.php?id=$id'><p class='column'><i class='fas fa-cart-plus'>Cart</i></p></a></div></div>";
echo $components;
}
